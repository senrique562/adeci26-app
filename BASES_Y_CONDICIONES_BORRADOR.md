# Bases y condiciones · «Tus 5 momentos en ADECI 2026» · BORRADOR

> Los campos entre corchetes se completan cuando ADOX defina premios y horarios. Recomendamos que lo revise quien asesore legalmente a ADECI o a ADOX antes de publicarlo en la app.

## 1. Organización
La actividad «Tus 5 momentos en ADECI 2026» (en adelante, «el Juego») es organizada por la Asociación Argentina de Enfermeros en Control de Infecciones (ADECI), [CUIT / domicilio], en el marco del Congreso ADECI 2026, con el patrocinio de ADOX S.A. [razón social y CUIT exactos], en adelante «el Sponsor». Los premios son aportados por el Sponsor.

## 2. Vigencia y lugar
El Juego se desarrolla exclusivamente durante el Congreso ADECI 2026, los días 17 y 18 de septiembre de 2026, en [sede], ciudad de Córdoba, Argentina, a través de la aplicación web del congreso disponible en `https://adeci26.netlify.app`.

## 3. Quiénes pueden participar
Puede participar toda persona mayor de 18 años que asista al Congreso y se registre en la aplicación con nombre, apellido y correo electrónico. La participación es gratuita y no requiere compra ni pago adicional alguno.
...
## 7. Premios
[Descripción de cada premio, cantidad y valor estimado. Ejemplo: «Un (1) kit de productos ADOX valuado en $ ___».] Los premios no son canjeables por dinero ni transferibles. El Sponsor es responsable de la entrega y de la garantía de los productos.

## 8. Uso correcto de la aplicación
...
## 11. Contacto
Consultas: adeci@adeci.org.ar · Sitio del congreso: https://adeci.org.ar/congresos/2026/

---
*Versión borrador · [fecha]*
